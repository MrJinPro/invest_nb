      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-semibold tracking-wide">
            ...
            <span>Проблема & Решение</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight font-['Outfit']">
            Проблемы Рынка и <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-sky-400 to-cyan-400">Решения NovaBoost</span>
          </h2>
          <p className="text-slate-400 text-base sm:text-lg leading-relaxed">
            Стриминговая индустрия перегружена фрагментированным софтом и высоким порогом монетизации. NovaBoost закрывает фундаментальные боли авторов.
          </p>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-r from-cyan-950/60 via-indigo-950/60 to-slate-900 border border-cyan-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-sm font-bold text-white">Стратегическое преимущество</h4>
